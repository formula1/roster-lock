import { RosterLockV1Config, SelectedPiece, UserInput } from "@match-lock/shared";


export async function makeSelect(rosterConfig: RosterLockV1Config): Promise<UserInput["userSelection"]>{
...
import { SelectionNormalConfig } from "@match-lock/shared";
