...
[Command]
; New for kfm_shadow - button z is unused by classic KFM, so it's free to
; dedicate to the Summon Shadow special. See readme.txt.
name = "QCF_z"
command = ~D, DF, F, z
...
;---------------------------------------------------------------------------
;Summon Shadow (new for kfm_shadow - see readme.txt)
[State -1, Summon Shadow]
type = ChangeState
value = 9800
