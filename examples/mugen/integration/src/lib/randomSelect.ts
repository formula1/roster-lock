// Generic, config-driven random selection builder - not mugen-specific.
// Copied from examples/full-local/game/game-headless/src/steps/0-select.ts
// (see the no-shared-package precedent between examples' integration
// scripts noted in lib/process-utils.ts).
import {
  RosterLockV1Config, SelectedPiece, UserSelection, SelectionNormalConfig
} from "@roster-lock/types";

export function selectPiecesAtRandom(rosterConfig: RosterLockV1Config): UserSelection {
