...
export function MergeForm(
  ...
  const untrustedScripts = usePromisedMemo(async ()=>{
    // Without an agent we can't tell which extensions are runnable - null
    // skips that validation rather than rejecting everything.
    if(!plugins) return null;
    return plugins.getScriptPlugins()
  }, [plugins]);
