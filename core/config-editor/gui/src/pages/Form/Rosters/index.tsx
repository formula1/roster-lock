...
import { AddPieceFromAgent } from "./PieceCollection/AddPieceFromAgent";
import type { PieceValue, PieceDraftInfo } from "./PieceCollection/types";
...
export function RosterConfigEditPage(){
  ...
  const addPiece = (
    { pieceDefinitionKey, piece, draftInfo }: {
