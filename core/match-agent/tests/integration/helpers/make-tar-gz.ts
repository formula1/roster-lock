...
// Builds a minimal ustar+gzip buffer by hand, so the download test can
// exercise the real gzip/tar plugins without a `tar` build dependency.
// Mirrors core/plugin-runtime/test/helpers/make-tar-gz.ts.
